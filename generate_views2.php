...
$modulesConfig = [
    'CRM' => ['viewPath' => 'leads/index.php', 'dataKey' => 'leads', 'title' => 'CRM Leads', 'cols' => ['Lead Name' => 'name', 'Company' => 'company', 'Email' => 'email', 'Stage' => 'stage']],
    'Reports' => ['viewPath' => 'index.php', 'dataKey' => 'reports', 'title' => 'Reports Engine', 'cols' => ['Report Name' => 'name', 'Type' => 'type', 'Last Run' => 'last_run']],
    'Dashboard' => ['viewPath' => 'index.php', 'dataKey' => 'metrics', 'title' => 'CEO Dashboard', 'cols' => ['Metric' => 'name', 'Value' => 'value']]
];
