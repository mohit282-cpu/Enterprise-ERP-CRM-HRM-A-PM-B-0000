<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <h4 class="fw-bold tracking-tight mb-0">Domain Names</h4>
...
<th>Status</th>
                ...
                <tbody>
                    <?php if(!empty($domains)): foreach($domains as $row): ?>
                    <tr>
        ...
        <form method="POST" action="/domains">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-light border-0">
                    <h5 class="modal-title fw-bold">Add Domain Names</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="/domains/update">
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-light border-0">
                    <h5 class="modal-title fw-bold">Edit Domain Names</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Registrar</label>
                        <input type="text" name="registrar" id="edit_registrar" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Expiry Date</label>
...
<script>
    function openEditModal(row) {
        ...
        document.getElementById('edit_name').value = row['name'] || '';
            document.getElementById('edit_registrar').value = row['registrar'] || '';
            document.getElementById('edit_expiry_date').value = row['expiry_date'] || '';
